...
{phang}{cmd:. rassign rassign rassign_1, group(rassign_3)}{p_end}
{phang}{cmd:. rassign rassign rassign_2, group(rassign_3)}{p_end}

{phang}
The data set rassign.xlsx can be downloaded from import excel "https://raw.githubusercontent.com/timbulwidodostp/rassign/main/rassign/rassign.xlsx", sheet("Sheet1") firstrow clear
...
{pstd}Timbul Widodo, Olah Data Semarang; https://www.youtube.com/@amalsedekah{p_end}
